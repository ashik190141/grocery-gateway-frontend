...
const CheckoutPage = () => {
    ...
    function createData(image:string, name:string, noOfProduct:number, price:number) {
    ...
    return (
      <div className="max-w-7xl mx-auto pt-52">
        ...
        <div className="flex justify-end py-3 text-blue-700">* Cash On Delivery</div>
        ...
        <div className="flex flex-col py-10">
          ...
          <div className="flex justify-end">
            <button onClick={handleCheckout} className="btn btn-warning uppercase">Proceed Checkout</button>
          </div>
        </div>
      </div>
    );
