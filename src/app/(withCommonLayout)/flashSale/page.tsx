...
const Completionist = () => <span>Offered Close!</span>;
          ...
          {products.map((product: any, i: any) => (
            <div key={product._id}>
              <div className="px-4 py-3 shadow-lg max-w-[450px] font-sans rounded-xl space-y-6 mx-auto bg-white">
                ...
                <div className="text-center text-3xl w-[85%] mx-auto font-semibold space-y-2">
                  <p className="text-xl">Offered Close After: </p>
                  <Countdown
                    date={
                      new Date(
                        currentDate.getTime() +
